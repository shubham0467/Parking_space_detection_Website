...
def get_data():
    if request.method == 'POST':
        ...
        cursor.execute(f"""INSERT INTO registration VALUES ('{name_}', '{email_id}', '{vehicle_number}', '{vehicle_type}', now());""")
...
def get_time():
    ...
    d_hrs=d_secs/(60*60)
    if d_hrs<=1:
        fees="""You've parked for less than or equal to an hour. So, you are charged\nRs 10"""
    elif d_hrs>1:
        fee=10+((d_hrs-1)*5)
